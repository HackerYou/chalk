	...
	render() {
		...
		return (
			<footer className="mainFooter card">
				...
				<p><strong>Copyright {year} <a href="http://hackeryou.com" className="blackLight" >HackerYou</a></strong><br /><small>The contents of this site are the property of HackerYou. No portion of this site is to be shared without permission.</small></p>
			</footer>
		)
	}
});